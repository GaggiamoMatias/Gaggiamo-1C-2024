/*! @mainpage Actividad 2 - Proyecto 2: Medidor de distancia por ultrasonido c/ interrupciones
 *
 ...
 * teclas y el control de tiempos.
 *  
...
#define CONFIG_PERIOD_MEASURE 500000
#define CONFIG_PERIOD_SHOW 200000
 ...
 */
void FuncTimerA(void* param){ vTaskNotifyGiveFromISR(measure_task_handle, pdFALSE); }
/**
 ...
 */
void FuncTimerB(void* param){ vTaskNotifyGiveFromISR(show_task_handle, pdFALSE); }
